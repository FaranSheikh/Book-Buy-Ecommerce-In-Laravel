                    ...
                    <div class="col-lg-12">
                        ...
                        @if (session('cart'))
                            <form action="#" method="post" class="cart-main">
                                ...
                                <table class="shop_table cart">
                                    ...
                                    @foreach (session()->get('cart') as $cartProduct)
                                        ...
                                        @php
                                            $cartTotalPrice += $cartProduct['price'] * $cartProduct['quantity']
                                        @endphp
                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-thumbnail">
                                                ...
                                                <div class="cart-product__item">
                                                    <a href="#">
                                                        <img src="{{ $cartProduct['image'] }}" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                                    </a>
                                                    <div class="cart-product-content">
                                                        <h5 class="cart-product-title">{{ $cartProduct['name'] }}</h5>
                                                    </div>
                                                </div>
                                            </td>
            
                                            <td class="product-price">
                                                <h5 class="price amount">{{ $cartProduct['price'] }}</h5>
                                            </td>
                                            ...
                                            <td class="product-quantity">
                                                ...
                                                <div class="quantity">
                                                    ...
                                                    <input title="Qty" class="email input-text qty text" type="text" value="{{ $cartProduct['quantity'] }}" placeholder="1" readonly>
                                            ...
                                            <td class="product-subtotal">
                                                <h5 class="total amount">{{ $cartProduct['price'] * $cartProduct['quantity'] }}</h5>
                                            </td>
                            ...
                            <div class="cart-total">
                                ...
                                <h5 class="cart-total-total">Total: <span class="price">{{ config('product.currency') }}{{ $cartTotalPrice }}</span></h5>
